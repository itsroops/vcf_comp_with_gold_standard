...
The compulsory options are the *gold standard file*, *bed file*, *reference file*, *account* and *partition name*. Both long as well as the short options or a combiination of both can be used. 
