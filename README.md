...
The compulsory options are the *gold standard file*, *bed file* and *reference file*. Both long as well as the short options or a combiination of both can be used. 
